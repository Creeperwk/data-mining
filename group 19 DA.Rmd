...
These variables are chosen because of their clear trend and representative values. A summary of the data distribution of selected variables is shown at the table below.
```{r summary table for raw variables, eval = TRUE,echo=FALSE}
...
```{r 6,echo=FALSE,eval=FALSE, fig.pos="H"}
#Full tree
set.seed(1)
